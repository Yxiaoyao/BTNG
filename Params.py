...
def parse_args():
	...
	parser.add_argument('--data', default='ml10m', type=str, help='name of dataset')
	...
	parser.add_argument('--graphSampleN', default=1000, type=int, help='use 25000 for training and 200000 for testing, empirically')
